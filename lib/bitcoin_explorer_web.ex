defmodule BitcoinExplorerWeb do
  @moduledoc """
  ...
  This can be used in your application as:
      ...
      use BitcoinExplorerWeb, :controller
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/bitcoin_explorer_web/templates",
        namespace: BitcoinExplorerWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {BitcoinExplorerWeb.LayoutView, "live.html"}
